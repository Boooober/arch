<?php function projects_tree ($category, $i = 0) {
    ...
    if(!empty($sub_cat_ids)){
        ...
        if ($i == 1) echo '<div class="inner-tab-caption empty"></div>';
        ...
        if ( $query->have_posts() ) :
            while ( $query->have_posts() ) : $query->the_post();
                ...
                ?>
                <a class="item js-overly-trigger js-single-ajax" href="<?php echo get_permalink(); ?>" data-project="<?php echo $post_id; ?>" data-overlay="#push-page">
